...
module.exports = function(Chart) {
	...
	Chart.controllers.line = Chart.DatasetController.extend({
      ...
      //console.log(this.getDataset().pointHitRadius);
...
module.exports = function(Chart) {
	...
	helpers.extend(Chart.Controller.prototype, {
      ...
      //console.log(eventPosition);
			...
			helpers.each(this.data.datasets, function(dataset, datasetIndex) {
				if (this.isDatasetVisible(datasetIndex)) {
          //console.log("trace1 "+datasetIndex);
					var meta = this.getDatasetMeta(datasetIndex);
		...
		getElementsAtEvent: function(e) {
			...
			helpers.each(this.data.datasets, function(dataset, datasetIndex) {
				if (this.isDatasetVisible(datasetIndex)) {
					var meta = this.getDatasetMeta(datasetIndex);
          //console.log(meta.data[found._index]);
...
module.exports = function(Chart) {
	...
	Chart.Tooltip = Chart.Element.extend({
        ...
        //console.log(this._options.tooltips.callbacks.label.call(this, bodyItem, data));
...
module.exports = function(Chart) {
	...
	var LogarithmicScale = Chart.Scale.extend({
      ...
      //alert("this.max is:"+this.max+"tickVal is:"+tickVal)
			while (tickVal <= this.max) {
				this.ticks.push(tickVal);
        //alert(tickVal);
				var exp = Math.floor(helpers.log10(tickVal));

        //Leo: change step from 1 to 2 so as to reduce label number
				var significand = Math.floor(tickVal / Math.pow(10, exp)) + 2;
        ...
        //Leo: keep only 10 float numbers to avoid jQuery float bug
        tickVal = parseFloat(tickVal.toFixed(10));
        //console.log(significand+" "+Math.pow(10, exp) +" "+tickVal);
			}
